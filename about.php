<?php 
$page ="About";
$title= "About-Us || TROPICS ENERGY SOLUTION LIMITED";
include'includes/header.php'; ?>
    <main>
                    ...
                    <div class="col-md-12">
                        <div class="it-breadcrumb-content">
                            <div class="it-breadcrumb-title-box mb-25 z-index-3">
                                <h3 class="it-breadcrumb-title text-white">About Us</h3>
                            </div>
                        ...
                        <div class="it-about-thumb-box p-relative">
                            <div class="it-about-shape-box">
                                ...
                                <div class="it-about-shape-3">
                                    <div class="it-about-experience-item p-relative theme-bg text-center">
                                        <h3 class="it-about-experience-title">7</h3>
                                        <span>Years of Experience</span>
                                    </div>
                                </div>
                                <div class="it-about-shape-4">
                                    <div class="it-about-video-thumb p-relative">
                                        <img src="assets/img/about/aboutimg.jpg" alt>
                                        <div class="it-about-video-icon">
                                            <a class="popup-video" href="assets/img/logo tropic/WhatsApp Video 2024-03-23 at 3.19.52 PM.mp4">
                            ...
                            <div class="it-about-thumb">
                                <img src="assets/img/logo tropic/Untitled design.jpg" alt>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6">
                        <div class="it-about-content-wrapp">
                            <div class="it-about-title-box mb-20">
                                <span class="it-subtitle">about us</span>
                                <h3 class="it-section-title">
                                    About Tropics Energy Solutions Pvt Ltd
                                </h3>
                            </div>
                            <div class="it-about-dsc mb-35">
                                <p style="text-align: justify;" >Welcome to Tropics Energy Solutions Pvt Ltd, a leading solar company dedicated to harnessing the power of the sun to create a brighter and sustainable future. As advocates for renewable energy, we strive to make solar solutions accessible, affordable, and efficient for homes, businesses, and communities worldwide. With a strong focus on innovation, quality, and customer satisfaction, we are committed to driving the global transition towards clean energy. </p>
                            </div>
                            <div class="it-about-2-item mb-15">
                                <div class="row">
                                    <div class="col-xl-6 col-md-6">
                                        <div class="it-about-item-text">
                                            <h3 class="it-section-title-sm mb-5">WHO WE ARE </h3>
                                            <div class="it-about-2-dsc">
                                                <p style="text-align: justify;" >At Tropics Energy Solutions Pvt Ltd we are a passionate team of solar enthusiasts, professionals, and visionaries, united by a common goal - to accelerate the adoption of solar energy as a clean and viable alternative to traditional power sources. With years of industry experience and a deep understanding of solar technology, we take pride in providing comprehensive solar solutions tailored to meet the unique energy needs of our diverse clientele.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xl-6 col-md-6">
                                        <div class="it-about-item-text">
                                            <h3 class="it-section-title-sm mb-5">OUR APPROACH </h3>
                                            <div class="it-about-item-2-dsc">
                                                <p style="text-align: justify;" >  We believe that every solar project is unique, and tailoring solutions to meet specific requirements is at the core of our approach. Our seasoned engineers work closely with clients to conduct thorough site assessments and feasibility studies, enabling us to design customized solar solutions that optimize energy output and maximize returns on investment</p>
                                            </div>
                                        </div>
                                    </div>
        ...
        <div class="it-funfact-area pt-120 pb-90 theme-bg" data-background="assets/img/funfact/funfact-bg.png">
            <div class="container">
                <div class="it-funfact-wrapp">
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-4 mb-30">
                            <div class="it-funfact-content text-center">
                                <h3 class="it-funfact-number">
                                    <b class=" purecounter" data-purecounter-duration="3" data-purecounter-end="100"></b>+
                                </h3>
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-4 mb-30">
                            <div class="it-funfact-content text-center">
                                <h3 class="it-funfact-number">
                                    <b class=" purecounter" data-purecounter-duration="2" data-purecounter-end="7"></b>+
                                </h3>
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-4 mb-30">
                            <div class="it-funfact-content text-center">
                                <h3 class="it-funfact-number">
                                    <b class=" purecounter" data-purecounter-duration="2"
                                        data-purecounter-end="12"></b>+
                                </h3>
                                <span class="it-funfact-title">Manufacturing workers</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-6">
                        <div class="it-work-title-box text-center mb-70">
                            <span class="it-subtitle mb-30">WORKING PROCESS</span>
                            <h3 class="it-section-title"> Solar Energy work Project Planning</h3>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 mb-30">
                            <div class="it-work-item text-center">
                                ...
                                <div class="it-work-content">
                                    <h3 class="it-section-title-sm">Project Planning</h3>
                                    <p>Efficient project planning is the bedrock of our solar energy service. From meticulous site assessments to seamless permitting.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-6 mb-30">
                            <div class="it-work-item text-center">
                                ...
                                <div class="it-work-content">
                                    <h3 class="it-section-title-sm">Research & Analysis</h3>
                                    <p>we stay ahead through continuous research, ensuring our solutions remain cutting-edge. Trust us to deliver tailored strategies backed by comprehensive analysis,</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-6 mb-30">
                            <div class="it-work-item text-center">
                                ...
                                <div class="it-work-content">
                                    <h3 class="it-section-title-sm">Installation amp Maintenance</h3>
                                    <p>Trust us to not only install your solar system but also provide ongoing maintenance, keeping it running at peak performance.</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="it-testimonial-2-area theme-bg pt-115 pb-120"
            data-background="assets/img/testimonial/testimonial-2-bg.png">
            <div class="container">
                <div class="row align-items-end">
                    <div class="col-xl-6 col-lg-6">
                        <div class="it-testimonial-2-title-box">
                            ...
                            <p>Embark on a journey through our success story at Tropic Energy, where every milestone is a testament to our commitment to bringing happiness through sustainable energy solutions. From humble beginnings to global recognition, discover how we've transformed communities and empowered individuals with the power of the sun.</p>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-xl-6 col-md-6 mb-20">
                                <div class="it-testimonial-2-review-box d-flex align-items-center">
                                    <div class="it-testimonial-2-review-icon">
                                        <span>
                                            <img src="assets/img/testimonial/google-icon.png" alt>
                                        </span>
                                    </div>
                                    <div class="it-testimonial-2-review-content">
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="it-testimonial-2-item p-relative">
                                            ...
                                            <p>“The customer service team at Tropics Energy Solution is incredible. They answered all my questions and made the transition to solar energy seamless.</p>
                                            <div
                                                class="it-testimonial-2-author d-flex align-items-center justify-content-between">
                                                <div class="it-testimonial-2-avater-box d-flex align-items-center">
                                                    <!-- <div class="it-testimonial-2-avater">
                                                        <img src="assets/img/testimonial/avater-2-1.png" alt>
                                                    </div> -->
                                                    <div class="it-testimonial-2-avater-info">
                                                        <h3 class="it-testimonial-2-avater-title">Pranav Bundela</h3>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="it-testimonial-2-item p-relative">
                                            ...
                                            <p>“I was impressed with the professionalism of the Tropics Energy Solution installation team. They did a thorough job and ensured everything was working perfectly.</p>
                                            <div
                                                class="it-testimonial-2-author d-flex align-items-center justify-content-between">
                                                <div class="it-testimonial-2-avater-box d-flex align-items-center">
                                                    <!-- <div class="it-testimonial-2-avater">
                                                    ...
                                                    <div class="it-testimonial-2-avater-info">
                                                        <h3 class="it-testimonial-2-avater-title">Aniket Mishra </h3>
                                                        <!-- <span>Project Manger </span> -->
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="it-testimonial-2-item p-relative">
                                            ...
                                            <p>“Thanks to Tropics Energy Solution, we are now proud contributors to a cleaner environment with our new solar energy system.</p>
                                            <div
                                                class="it-testimonial-2-author d-flex align-items-center justify-content-between">
                                                <div class="it-testimonial-2-avater-box d-flex align-items-center">
                                                   
                                                    <div class="it-testimonial-2-avater-info">
                                                        <h3 class="it-testimonial-2-avater-title">Mukesh Singh</h3>
