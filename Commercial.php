<?php 
$page ="Commercial";
$title= "Commercial || TROPICS ENERGY SOLUTION LIMITED";
                    ...
                    <div class="col-md-12">
                        <div class="it-breadcrumb-content">
                            <div class="it-breadcrumb-title-box mb-25 z-index-3">
                                <h3 class="it-breadcrumb-title text-white">Commercial</h3>
                            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-4 col-lg-6 col-md-6 mb-30">
                        <div class="it-product-item">
                            <div class="it-product-thumb mb-40 grey-bg p-relative">
                                <img src="assets/img/commercial/1.jpeg" alt>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 mb-30">
                        <div class="it-product-item">
                            <div class="it-product-thumb mb-40 grey-bg p-relative">
                                <img src="assets/img/commercial/2.jpg" alt>
                                <div class="it-product-icon">
                                    <a href="Commercial.html#"><i class="fa-solid fa-heart"></i></a>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 mb-30">
                        <div class="it-product-item">
                            <div class="it-product-thumb mb-40 grey-bg p-relative">
                                <img src="assets/img/commercial/3.jpg" alt>
                                <div class="it-product-icon">
                                    <a href="Commercial.html#"><i class="fa-solid fa-heart"></i></a>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 mb-30">
                        <div class="it-product-item">
                            <div class="it-product-thumb mb-40 grey-bg p-relative">
                                <img src="assets/img/commercial/4.jpg" alt>
                                <div class="it-product-icon">
                                    <a href="Commercial.html#"><i class="fa-solid fa-heart"></i></a>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 mb-30">
                        <div class="it-product-item">
                            <div class="it-product-thumb mb-40 grey-bg p-relative">
                                <img src="assets/img/commercial/5.jpg" alt>
                                <div class="it-product-icon">
                                    <a href="Commercial.html#"><i class="fa-solid fa-heart"></i></a>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 mb-30">
                        <div class="it-product-item">
                            <div class="it-product-thumb mb-40 grey-bg p-relative">
                                <img src="assets/img/commercial/6.jpg" alt>
                                <div class="it-product-icon">
                                    <a href="Commercial.html#"><i class="fa-solid fa-heart"></i></a>
                                </div>
                            </div>
